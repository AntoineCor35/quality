<!-- Non-respect des conventions PSR : indentation irrégulière, espaces incohérents, balises mal alignées -->
@extends('layouts.app')
...
<h5 class = "border-bottom pb-2"> Informations personnelles </h5>
 ...
 <strong>Date de naissance:</strong> {{$client->date_naissance ? $client->date_naissance->format('d/m/Y') : 'Non renseignée'}}
 </div>
 </div>
 </div>
 <div class = "col-md-6">
